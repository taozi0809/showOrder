$(function(){
    ...
    var userInfo = {
        ...
        ability:['认知能力','动手能力','创造力','大动作','精细动作'],//培养宝宝的能力，固定5个
    ...
    var userHtml = {
        ...
        fifthAbility:[
            '<ul class="ability-ul bobbingUpDown"><span class="animation-txt animation-txt1 fadeIn-1s">'+userInfo.ability[0]+'</span></ul>',
                                ...
                                _('.second-txt').addEventListener("webkitAnimationEnd", function(){
                                    ...
                                    if(userInfo.playedToysImgUrl.length == 1){
                                        _('.line3').addEventListener("webkitAnimationEnd", function() {
                                            // 第一位置
                                            $('.bask').append(userHtml.allPlayedToys[0].threeData1In)
                                            afterAll('.three-data1')
                                        },false)
                                    }
